...
var arr=['https://bestmobileappawards.com/pub/wpscreenshots/calendar-1.png','https://picsum.photos/1920/1200?image=836','https://picsum.photos/1920/1200?image=823','https://picsum.photos/1920/1200?image=817','https://picsum.photos/1920/1200?image=797']; //an array of image sources
var pos=0; //initializes image position in the array
$(document).ready(function () {
    var interval=5000; //interval for slide
    var loaderHtml='Loading..';
    ...
    $('#slider').html(`<img src="`+arr[0]+`" class="img-slide image-animated""><h3 class = 'p-1 text-center text-light'>Updated Routines...</h3>`);//show first image
    ...
    function autoSlide(arr,interval){
        ...
        setInterval(function () {
            ...
            $('#slider').html(`<img src="`+arr[pos]+`" class="img-slide img'+pos+' image-animated"><h3 class = 'text-center text-light'>Updated Routines...</h3>`);//shows image
